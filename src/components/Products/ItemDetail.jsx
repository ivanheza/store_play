      ...
      {loading ? (
        ...
        <div className="row flex-lg-row align-items-center g-2">
          ...
          <div className="col-lg-6">
            ...
            <div>
              <h2>
                Precio: <span className="mx-3">$ {precio}</span>
              </h2>
            </div>
            {!inCart(id) ? (
              <div>
              ...
              <div>
                ...
                <div className="text-center m-0">
                  <span className="badge bg-light text-dark m-0">
                    Agregaste {cantProd(id)} al carrito
                  </span>
                </div>
                <div className="row justify-content-center align-items-center mb-2">
                  ...
                  <Link to="/" className={`col-4  m-0 btn btn-secondary`}>
                    Volver a Tienda
                  </Link>
                </div>
              </div>
