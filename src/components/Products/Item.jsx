         ...
         <div className="card h-100 rounded-3 shadow-sm">
            ...
            <div className="card-body">
               <div className="clearfix mb-3">
                  ...
                  <span className="m-3">
                     {!inWishList(id) ? (
                        <AiOutlineHeart cursor="pointer" size="25" onClick={handleLike} />
                     ) : (
                        <p className="m-0 p-0">
                           En WishList
                           <AiFillHeart size="25" cursor="pointer" onClick={handleLike} />
                        </p>
                     )}
                  </span>
               </div>
            ...
            <div className="text-center my-3">
               <Link to={`/detalle/${id}`} className=" btn w-75 btn-outline-primary ">
                  Ver Detalle
               </Link>
            </div>
         </div>
